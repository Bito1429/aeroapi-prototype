...
function circMean(degs){
 const sx=degs.reduce((s,x)=>s+Math.cos(rad*x),0),sy=degs.reduce((s,x)=>s+Math.sin(rad*x),0);
...
await fs.writeFile("artifacts/arrival-direction-inference-development-v2.json",JSON.stringify(report,null,2));
