...
const DAYS={
 "18":[new Date("2026-09-18T10:00:00Z"),new Date("2026-09-18T22:00:00Z")],
 "19":[new Date("2026-09-19T10:00:00Z"),new Date("2026-09-19T22:00:00Z")],
 "20":[new Date("2026-09-20T10:00:00Z"),new Date("2026-09-20T22:00:00Z")]
};
const BATCH_AFTER=new Date("2026-09-17T17:45:00Z");
const TARGET=500;
const STEP=50;
...
export default async function handler(req,res){try{
 ...
 if(!DAYS[day])return json(res,400,{ok:false,error:"day must be 18, 19, or 20"});
 ...
 if(scanStart>=END)return json(res,409,{ok:false,done:false,day,batch_total:cohort.length,target:TARGET,error:"90-minute window closed",scan_start:scanStart});
