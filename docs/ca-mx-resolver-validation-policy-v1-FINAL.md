# Canada + Mexico resolver validation policy v1 — FINAL before candidate retrieval — frozen before historical cohort retrieval

Frozen: 2026-09-21. Supersedes v0 before any Canada/Mexico candidate retrieval.
...
- aircraft type
- scheduled duration
- flight status text, used only to exclude cancelled/non-completed records
